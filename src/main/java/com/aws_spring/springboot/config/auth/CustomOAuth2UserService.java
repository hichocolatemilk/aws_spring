...
import com.aws_spring.springboot.domain.user.User;
import com.aws_spring.springboot.domain.user.UserRepository;
import com.aws_spring.springboot.config.auth.dto.OAuthAttributes;
